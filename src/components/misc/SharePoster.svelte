...
<button
	class="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--btn-regular-bg)] hover:bg-[var(--btn-plain-bg-hover)] text-[var(--primary)] transition-all active:scale-95"
